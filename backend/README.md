...
## Project Structure
    ...
    ├── testapiautostoryboa_82820  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_82820`
...
2. Clone this repo and `cd testapiautostoryboa_82820`
